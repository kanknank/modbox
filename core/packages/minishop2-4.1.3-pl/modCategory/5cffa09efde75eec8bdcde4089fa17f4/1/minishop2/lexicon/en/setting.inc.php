...
$_lang['setting_ms2_cart_js_class_name'] = 'The name of the cart control JS class';
$_lang['setting_ms2_cart_js_class_name_desc'] = 'The class should be exported by default';
$_lang['setting_ms2_cart_js_class_path'] = 'Path to cart control JS';
...
$_lang['setting_ms2_frontend_message_css_desc'] = 'The path to the CSS file for your notification library. By default to jgrowl. <br>If you want to use your own library, specify the path to its CSS directory here, or clear the parameter and load them manually through the site template.';
$_lang['setting_ms2_frontend_message_js'] = 'Notification library scripts';
$_lang['setting_ms2_frontend_message_js_desc'] = 'The path to the JS file of your notification library. By default to jgrowl. <br>If you want to use your own library, specify the path to its JS directory here, or clear the parameter and load them manually through the site template.';
...
$_lang['setting_ms2_frontend_notify_js_settings'] = 'Notification settings for the new version of scripts';
$_lang['setting_ms2_frontend_notify_js_settings_desc'] = 'Path to the settings file. Please note that the file must be in JSON format';
$_lang['setting_ms2_notify_js_class_name'] = 'The name of the showing notifications JS class';
$_lang['setting_ms2_notify_js_class_name_desc'] = 'The class should be exported by default';
$_lang['setting_ms2_notify_js_class_path'] = 'Path to showing notifications JS class';
$_lang['setting_ms2_notify_js_class_path_desc'] = 'Relative to the assets/components/minishop2/js/web/modules folder';
...
$_lang['setting_ms2_order_format_num'] = 'Order numbering format';
...
$_lang['setting_ms2_order_js_class_name'] = 'The name of the ordering JS class';
$_lang['setting_ms2_order_js_class_name_desc'] = 'The class should be exported by default';
$_lang['setting_ms2_order_js_class_path'] = 'Path to ordering JS class';
$_lang['setting_ms2_order_js_class_path_desc'] = 'Relative to the assets/components/minishop2/js/web/modules folder';
...
$_lang['setting_ms2_product_id_as_alias'] = 'Use ID of category as alias';
$_lang['setting_ms2_product_id_as_alias_desc'] = 'If true, aliases for friendly urls of categories will don be generated. ID will be set as alias.';
...
$_lang['setting_ms2_tmp_storage'] = 'Storage of the cart and temporary order fields';
$_lang['setting_ms2_tmp_storage_desc'] = 'Specify <strong>session</strong> to store the cart and temporary order fields in the session. <br>For database storage, specify <strong>db</strong>';
$_lang['setting_ms2_toggle_js_type'] = 'Enable new JavaScript?';
$_lang['setting_ms2_toggle_js_type_desc'] = 'If YES is selected, will be included scripts without dependence on jQuery and written using the features of the ES6 standard';
...
$_lang['setting_ms2_vanila_js'] = 'New frontend scripts';
$_lang['setting_ms2_vanila_js_desc'] = 'Path to file with scripts. If you want to use your own sscripts - specify them here, or clean this parameter and load them in template.';
