...
$_lang['ms2_prop_ignoreGroups'] = 'Comma-separated groups, whose options do not need to be displayed in the list.';
...
$_lang['ms2_prop_master'] = 'Master product ID. If specified both "master" and "slave" - query will built for master.';
...
$_lang['ms2_prop_showZeroPrice'] = 'Show products whose price is zero.';
$_lang['ms2_prop_slave'] = 'Slave product ID. If specified "master" this option will be ignored.';
$_lang['ms2_prop_sortGroups'] = 'Specifies the order in which option groups are sorted. Accepts both IDs and text group names. Send as a string, for example: "22,23,24" or "Dimensions, Electronics, Other".';
$_lang['ms2_prop_sortOptionValues'] = 'Specifies the sort order of option values. Passed as a string, e.g.: "size:SORT_DESC:SORT_NUMERIC:100,color:SORT_ASC:SORT_STRING"';
$_lang['ms2_prop_sortOptions'] = 'Specifies the sorting order for options. Passed as a string, e.g.: "size,color".';
...
$_lang['ms2_prop_tplDeliveriesOuter'] = 'Chunk for templating of a block of possible shipment methods.';
$_lang['ms2_prop_tplDeliveriesRow'] = 'Chunk to process a shipment method.';
...
$_lang['ms2_prop_tplSuccess'] = 'Chunk with successful message about snippet work.';
